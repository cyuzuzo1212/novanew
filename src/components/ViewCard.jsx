    ...
    <div className='ViewCard-cOntainer'>
      ...
      <div className='img-view-contain2'/>
        ...
        <div className='text-line'>
          <span className='text1'>Bed</span> <span className='text-num1'>6</span>
          </div>
          <hr/>
          <div className='text-line1'>
          <span className='text2'>Bath</span> <span className='text-num2'>8</span>
          </div>
          <hr/>
          <div className='text-line2'>
          <span className='text3'>Sq Ft</span> <span className='text-num3'>7,380</span>
          </div>
          <hr/>
          <div className='text-line3'>
          <span className='text4'>Price Per Sq Ft</span> <span className='text-num4'>$674.80</span>
          </div>
          <hr/>
          <div className='text-line4'>
          <span className='text5'>Year Built</span> <span className='text-num5'>2009</span>
          </div>
          <hr/>
          <div className='text-line5'>
          <span className='text6'>Lost Size</span> <span className='text-num6'>1.01 Acres</span>
          </div>
          <hr/>
          <div className='text-line6'>
          <span className='text7'>Community</span> <span className='text-num7'>Cielo</span>
          </div>
          <hr/>
